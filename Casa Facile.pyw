...
class GestioneSpese(tk.Tk):
    ...
    def __init__(self):
        ...
        menu_funzioni.add_command(label="📋 Promemoria", accelerator="Ctrl+Y", command=self.gestisci_promemoria)
        self.bind_all("<Control-y>", lambda e: self.gestisci_promemoria())
        menu_funzioni.add_command(label="📋 Ricorrenze", accelerator="Ctrl+T", command=self.mostra_ricorrenza_popup)
        self.bind_all("<Control-t>", lambda e: self.mostra_ricorrenza_popup())
        menu_funzioni.add_command(label="📊 Finanziamenti", accelerator="Ctrl+O", command=self.calcolo_mutuo_prestito)
        ...
        menu_funzioni.add_separator()
        menu_funzioni.add_command(label="✖️ Riduci a icona",accelerator="Ctrl+X",command=self.iconify)
        ...
        style.configure("Salva.TButton", background="#FF6666", foreground="black", font=("Arial", 8))  
        style.configure("Importa.TButton", background="#90EE90", foreground="black", font=("Arial", 8)) 
        style.configure("Esporta.TButton", background="#FFA500", foreground="black", font=("Arial", 8)) 
        style.configure("Reset.TButton", background="red", foreground="black", font=("Arial", 8))  
        style.configure("Info.TButton", background="green", foreground="black", font=("Arial", 8))  
        style.configure("Saldo.TButton", background="#FFA500", foreground="black", font=("Arial", 8)) 
        style.configure("Confronta.TButton", background="yellow", foreground="black", font=("Arial", 8))  
        style.configure("Utenze.TButton", background="#90EE90", foreground="black", font=("Arial", 8))  
        style.configure("Rubrica.TButton", background="#90EE90", foreground="black", font=("Arial", 8)) 
        style.configure("Stampa.TButton", background="#90EE90", foreground="black", font=("Arial", 8))  
        style.configure("Cerca.TButton", background="yellow", foreground="black", font=("Arial", 8))  
        style.configure("TM.TButton", background="yellow", foreground="black", font=("Arial", 8))  
        style.configure("Gruppi.TButton", background="yellow", foreground="black", font=("Arial", 8))  
        style.configure("Report.TButton", background="yellow", foreground="black", font=("Arial", 8))
        style.configure("Finanziamenti.TButton", background="yellow", foreground="black", font=("Arial", 8))    
        style.configure("Webserver.TButton", background="#90EE90", foreground="black", font=("Arial", 8))  
        style.configure("Webserver_port.TButton", background="#90EE90", foreground="black", font=("Arial", 8))  
        style.configure("Manuale.TButton", background="#FFA500", foreground="black", font=("Arial", 8)) 
        style.configure("Oggi.gold.TButton", background="gold", foreground="black", font=("Arial", 8, "bold")) 
        ...
        if self.modalita == "avanzata":
         ...
         ttk.Button(topbar, text="🔍 Finanziamenti", command=self.calcolo_mutuo_prestito, style="Finanziamenti.TButton").pack(side=tk.LEFT, padx=1)
        ...
        btn_oggi = ttk.Button(legenda, text="↺ Oggi", command=self.goto_today, width=8, style="Oggi.gold.TButton")
        ...
        barra_azione.pack(fill="x", pady=(3, 0))
        ...
        if self.modalita == "avanzata":
         ...
         btn_webserver_port = ttk.Button(barra_azione, text="🌐 WebServer port", width=20, command=self.apri_webserver_port, style="Webserver_port.TButton")
        ...
        btn_importa_popup = ttk.Button(data_frame, text="📥 Importa", command=self.apri_finestra_importa, style="AggiungiSpesa.TButton")
        ...
        style.configure("Reset.TButton", foreground="black", background="red", font=("Arial", 8))
        style.configure("Ricorrenze.TButton", foreground="black", background="orange", font=("Arial", 8))
        style.configure("AggiungiCategoria.TButton", foreground="black", background="#32CD32", font=("Arial", 8))
        style.configure("ElencoCategorie.TButton", foreground="black", background="#32CD32", font=("Arial", 8))
        ...
        style.configure("Promemoria.TButton", foreground="black", background="orange", font=("Arial", 8))
        style.configure("Chiudi.Ricorrenze.TButton", background="yellow", foreground="black", font=("Arial", 8))  # Lista Ricorrenze - arancione
        ...
        style.configure("Salva.Promemoria.TButton", background="#32CD32", foreground="black", font=("Arial", 8))  # Lista Ricorrenze - arancione
        style.configure("Esporta.Promemoria.TButton", background="#FFA500", foreground="black", font=("Arial", 8))  # Lista Ricorrenze - arancione
        style.configure("Chiudi.Promemoria.TButton", background="yellow", foreground="black", font=("Arial", 8))  # Lista Ricorrenze - arancione
        ...
        self.btn_reset_form = ttk.Button(pannello_bottoni,text="↺",width=2,command=self.reset_form, style="Reset.TButton")
        ...
        btn_ricorrenze = ttk.Button(pannello_bottoni, text="✅ Ricorrenze", command=lambda: self.mostra_ricorrenza_popup(), style="Ricorrenze.TButton")
        btn_ricorrenze.pack(side="left", padx=4)
        self.btn_gestisci_categorie = ttk.Button(pannello_bottoni, text="✅ Categorie", command=lambda: self.mostra_categorie_popup(), style="AggiungiCategoria.TButton")
        self.btn_gestisci_categorie.pack(side="left", padx=4)
        self.btn_promemoria = ttk.Button(pannello_bottoni, text="📝", command=self.gestisci_promemoria, style="Promemoria.TButton", width=2)
    ...
    def mostra_categorie_popup(self):
        ...
        self.tipo_categoria = tk.StringVar(value="Uscita")
        self.tipo_mod_menu = ttk.Combobox(
            aggiungi_cat_frame,
            textvariable=self.tipo_categoria,
            values=["Entrata", "Uscita"],
            state="readonly",
            width=10
        )
        self.tipo_mod_menu.grid(row=0, column=3, sticky="w", padx=2, pady=2)
        ...
        ttk.Button(btn_frame_cat, text="➕ Aggiungi", command=self.add_categoria, style="AggiungiCategoria.TButton").pack(side="left", padx=2)
        self.btn_modifica_categoria = ttk.Button(btn_frame_cat, text="⚙️ Modifica", command=self.modifica_categoria, style="ModificaNome.TButton")
        self.btn_modifica_categoria.pack(side="left", padx=2)
        self.btn_cancella_categoria = ttk.Button(btn_frame_cat, text="❌ Cancella", command=self.cancella_categoria, style="CancellaCategoria.TButton")
        self.btn_cancella_categoria.pack(side="left", padx=2)
        ttk.Button(btn_frame_cat, text="✨", command=self.apri_categorie_suggerite, style="SuggerisciCategoria.TButton", width=2).pack(side="left", padx=2)
        ttk.Button(btn_frame_cat, text="📋 Elenco", command=self.mostra_tutte_le_categorie, style="ElencoCategorie.TButton").pack(side="left", padx=2)

        style = ttk.Style()
        style.configure("Yellow.TButton", background="yellow")
        ttk.Button(main_frame, text="Chiudi", command=self.categorie_popup.withdraw, style="Yellow.TButton").pack(side="bottom", pady=(0, 2))
    ...
    def mostra_ricorrenza_popup(self):
        ...
        if hasattr(self, 'ricorrenza_popup') and self.ricorrenza_popup.winfo_exists():
            # Resetta i parametri quando la finestra è già creata e viene riaperta
            ...
            self.ricorrenza_popup.deiconify() # Mostra la finestra
            return
        ...
        self.ricorrenza_popup.protocol("WM_DELETE_WINDOW", lambda: (
            self.importo_ricorrenza.set(""),
            self.ricorrenza_tipo.set("Nessuna"),
            self.ricorrenza_n.set(1),
            self.ricorrenza_data_inizio.set(oggi),
        ...
        self.ricorrenza_popup.bind("<Escape>", lambda event: (
            self.importo_ricorrenza.set(""),
            self.ricorrenza_tipo.set("Nessuna"),
            self.ricorrenza_n.set(1),
            self.ricorrenza_data_inizio.set(oggi),
        ...
        if not hasattr(self, 'importo_ricorrenza'):
            ...
            self.ricorrenza_tipo_voce = tk.StringVar(value="Uscita") # Valore predefinito
            
        def aggiorna_importo_principale(*args):
            importo_dal_popup = self.ricorrenza_imp.get()
            self.imp_entry.delete(0, tk.END)
            self.imp_entry.insert(0, importo_dal_popup)
        ...
        ric_frame.grid_columnconfigure(1, weight=1)

        row = 0
        ttk.Label(ric_frame, text="💰 Importo (€):").grid(row=row, column=0, sticky="e", padx=2, pady=2)
        def convalida_importo(valore):
            import re
            return re.fullmatch(r"^\d{0,6}(?:[.,]\d{0,2})?$", valore) is not None
        vcmd_importo = ric_frame.register(convalida_importo)

        self.ric_imp_entry = ttk.Entry(
            ric_frame,
            width=10,
            textvariable=self.ricorrenza_imp,
            validate="key",
            validatecommand=(vcmd_importo, "%P")
        )
        ...
        self.ric_cat_menu = ttk.Combobox(ric_frame, textvariable=self.ricorrenza_cat_sel, values=sorted(self.categorie), state="readonly", width=25, font=("Arial", 11, "bold"))
        ...
        self.ric_desc_entry = ttk.Entry(ric_frame, width=30, textvariable=self.ricorrenza_desc, validate="key", validatecommand=(vdesc, "%P"))
        ...
        self.ricorrenza_tipo_voce_combobox = ttk.Combobox(
            ric_frame, 
            textvariable=self.ricorrenza_tipo_voce, 
            values=["Uscita", "Entrata"],
            state="readonly" # Rende la combobox non modificabile dall'utente
         )
        self.ricorrenza_tipo_voce_combobox.grid(row=row, column=1, sticky="w", padx=2, pady=2)
        self.ricorrenza_tipo_voce_combobox.current(0) # Imposta "Uscita" come opzione predefinita
        row += 1
    
        ttk.Label(ric_frame, text="📅 Ripeti:").grid(row=row, column=0, sticky="e", padx=2, pady=2)
        ...
        self.ric_combo.grid(row=row, column=1, sticky="w", padx=2, pady=2)
        
        ttk.Label(ric_frame, text="Ripeti volte:").grid(row=row, column=2, sticky="e", padx=2, pady=2)
        ...
        self.ric_n_entry.grid(row=row, column=3, sticky="w", padx=2, pady=2)
        
        ttk.Label(ric_frame, text="Inizio:").grid(row=row, column=4, sticky="e", padx=2, pady=2)
        ric_data_frame = ttk.Frame(ric_frame)
        ric_data_frame.grid(row=row, column=5, sticky="w", padx=2, pady=2)
        ...
        # Riquadro (Frame) per i pulsanti, per mantenerli vicini
        btn_frame = ttk.Frame(ric_frame)
        btn_frame.grid(row=row, column=0, columnspan=10, pady=5)

        self.btn_add_ricorrenza = ttk.Button(btn_frame, text="📂 Aggiungi", command=self.add_ricorrenza, style="AggiungiRicorrenza.TButton")
        self.btn_add_ricorrenza.pack(side="left", padx=4)
        
        self.btn_reset_ricorrenza = ttk.Button(btn_frame, text="↺", width=2, style="CancellaRicorrenza.TButton", command=lambda: (
            self.importo_ricorrenza.set(""),
            self.ricorrenza_tipo.set("Nessuna"),
            self.ricorrenza_n.set(1),
            self.ricorrenza_data_inizio.set(oggi),
        ...
        if self.modalita == "avanzata": 
          self.btn_cancella_ricorrenza = ttk.Button(btn_frame, text="❌ Cancella", command=self.del_ricorrenza, style="CancellaRicorrenza.TButton")
          self.btn_cancella_ricorrenza.pack(side="left", padx=4)

        self.btn_modifica_ricorrenza = ttk.Button(btn_frame, text="🔄 Lista", command=self.mostra_lista_ricorrenze, style="ListaRicorrenze.TButton")
        self.btn_modifica_ricorrenza.pack(side="left", padx=4)
        
        self.btn_chiudi_ricorrenza = ttk.Button(btn_frame, text="🟡 Chiudi", command=self.ricorrenza_popup.withdraw, style="Chiudi.Ricorrenze.TButton")
    ...
    def gestisci_promemoria(self):
        ...
        btn_salva_promemoria = ttk.Button(main_frame, text="✅ Salva", command=salva_promemoria, style="Salva.Promemoria.TButton")
        btn_salva_promemoria.grid(row=1, column=0, padx=5, sticky="e")
        btn_esporta_promemoria = ttk.Button(main_frame, text="📄 Esporta", command=esporta_promemoria, style="Esporta.Promemoria.TButton")
        btn_esporta_promemoria.grid(row=1, column=1, padx=5, sticky="we")
        btn_cancella_promemoria = ttk.Button(main_frame, text="❌ Chiudi", command=chiudi_promemoria_popup, style="Chiudi.Promemoria.TButton")
    ...
    def mostra_spese_simili(self):
        ...
        # Campo per modificare il margine di tolleranza
        tk.Label(
            popup,
    ...
    def mostra_tutte_le_categorie(self):
        ...
        for nome in sorted(self.categorie):
            tipo = self.categorie_tipi.get(nome, "Uscita")
            riga = f"• {nome}  ("
    ...
    def mostra_lista_ricorrenze(self):
        ...
        def treeview_sort_column(tv, col, reverse):
            ...
            # Converte i valori numerici in float per un ordinamento corretto
            try:
                l.sort(key=lambda t: float(t[0].replace(' €', '').replace(',', '.').strip()), reverse=reverse)
            except (ValueError, IndexError):
                # Se non è un numero, ordina come stringa
                l.sort(key=lambda t: t[0], reverse=reverse)
            for index, (val, k) in enumerate(l):
                tv.move(k, '', index)
            # Aggiorna il comando per invertire l'ordine al prossimo clic
        ...
        lista_window_width = 1220
        lista_window_height = 400
        ...
        cancel_button = tk.Button(button_frame, text="❌ Cancella Selezionate", command=_delete_selected_ricorrenze, bg="red", fg="white")
        cancel_button.pack(side="left", padx=5)
        close_button = tk.Button(button_frame, text="✅ Chiudi", command=lista_window.destroy, bg="gold", fg="black")
    ...
    def goto_today(self):
        ...
        self.update_spese_mese_corrente()
        m = today.month
        self.estratto_month_var.set(months[m-1])
    ...
    def open_compare_window(self):
        ...
        tk.Button(right_select_frame, text="↺", command=reset_right, width=2, bg="gold", fg="black").pack(side="right", padx=7)
        ...
        tk.Button(btnframe, text="❌ Chiudi", command=popup.destroy, width=14, bg="gold", fg="black").pack(side=tk.RIGHT, padx=8)
    ...
    def calcolo_mutuo_prestito(self):
        ...
        def esporta_dati_con_preview():
            ...
            ttk.Button(button_frame, text="Salva", command=salva_effettivamente, style='mutuo_prestito_green.TButton').pack(side=tk.LEFT, padx=5)
            ttk.Button(button_frame, text="Chiudi", command=preview_window.destroy, style='mutuo_prestito_yellow.TButton').pack(side=tk.LEFT, padx=5)
        ...
        style.configure('mutuo_prestito_green.TButton', background='green', foreground='black')
        style.configure('mutuo_prestito_yellow.TButton', background='yellow', foreground='black')
        ...
        btn_calcola_simulazioni = ttk.Button(simulazioni_frame, text="Calcola Tutte le Simulazioni", command=calcola_tutte_simulazioni, style='mutuo_prestito_green.TButton')
        btn_calcola_simulazioni.grid(row=7, column=0, columnspan=12, pady=10)
        ...
        ttk.Button(common_button_frame, text="Esporta Riepilogo", command=esporta_dati_con_preview, style='mutuo_prestito_green.TButton').pack(side=tk.LEFT, padx=5) # Rimuovi expand=True e fill=tk.X
        ttk.Button(common_button_frame, text="Chiudi", command=root.destroy, style='mutuo_prestito_yellow.TButton').pack(side=tk.LEFT, padx=5) # Rimuovi expand=True e fill=tk.X
    ...
    def time_machine(self):
        ...
        def aggiorna_categorie():
            ...
            # aggiungi anche il campo "risparmio"
        ...
        def aggiorna_interfaccia(*_):
            ...
            for cat, dati in top_cat:
                ...
                txt = f"{cat} – {dati['count']}×, Risparmio: {dati['risparmio']:.2f} € (Uscite: {dati['uscite']:.2f} - Entrate: {dati['entrate']:.2f})"
        ...
        def esegui_simulazione():
            ...
            for cat, n, usc, ent, risp in risultati:
                lines.append(f"{cat:<25} {n:>4}   {usc:>12.2f}   {ent:>12.2f}   {risp:>14.2f}")
                totale += risp
            lines.append("-" * 77)
    ...
    def gestione_login(self):
        ...
        def mostra_finestra_login():
            ...
            if os.path.exists(PW_FILE):
                  ...
                  tk.Label(login, text=f"Utente:► {current_folder} \n\n🔑 Inserisci la password:\n\n Premi Invio per confermare ►", font=("Arial", 10,"bold")).pack(pady=(15, 5))
            else:
        ...
        if "auto" in args:
            ...
            if salvata and hash_pw(arg_password) == salvata:
                ...
                login_riuscito[0] = True
                #iconizza la finestra dopo 3 secondi se auto e' tra gli argomenti
        ...
        # Se "auto" non è presente, mostra login GUI
        mostra_finestra_login()
        return login_riuscito[0]
    ...
    def apri_categorie_suggerite(self):
        ...
        #  Fase delicata: frame interno + associazione corretta
        scroll_frame = tk.Frame(canvas, bg="white")
        canvas_window = canvas.create_window((0, 0), window=scroll_frame, anchor="nw")

        #  Aggiorna area scrollabile in base al contenuto
    ...
    def stats_mensili_html(self):
        ...
        def genera_html_categorie(categorie_totals, raw_dettaglio, prefix, counts_dict):
            ...
            for cat, totale in sorted(categorie_totals.items()):
                ...
                # Recupera il conteggio delle operazioni per questa categoria
                num_operations = counts_dict.get(cat, 0)
                # Aggiungi il numero di operazioni accanto al nome della categoria
    ...
    def check_aggiornamento_con_api(self):
        ...
        try:
            ...
            if remote_time.date() > local_time.date():
                ...
                # Funzione countdown con colore dinamico
                ...
                tk.Button(frame_bottoni, text="🔄 AGGIORNA", command=aggiorna, bg="#A9DFBF", font=("Arial", 8), height=1, width=12).pack(side="left", padx=5)
                tk.Button(frame_bottoni, text="❌ CHIUDI", command=chiudi, bg="#F5B7B1", font=("Arial", 8), height=1, width=12).pack(side="left", padx=5)
                tk.Button(frame_bottoni, text="⏳ RIMANDA", command=rimanda, bg="#F9E79F", font=("Arial", 8), height=1, width=12).pack(side="left", padx=5)
