...
class GestioneSpese(tk.Tk):
    ...
    def gestione_login(self):
        ...
        def mostra_finestra_login():
            ...
            tk.Label(login, text="🔑 Inserisci la password:", font=("Segoe UI", 10)).pack(pady=(15, 5))
            entry_pw = tk.Entry(login, show="*", width=26)
            
            entry_pw.pack()
            entry_pw.focus()

            messaggio_errore = tk.Label(login, text="", fg="red", font=("Segoe UI", 9))
            ...
            def conferma_login():
                ...
                if not salvata:
                    ...
                    messaggio_errore.config(
                        text="✅ Benvenuto! Password creata con successo.",
                        fg="green"
                   )
