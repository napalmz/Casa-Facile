...
# 🔴 Riepilogo Mese
    ...
    def gestisci_promemoria(self):
        ...
        promemoria_popup.minsize(width=400, height=300)
        ...
        promemoria_popup.update_idletasks()
        window_width = promemoria_popup.winfo_width()
        window_height = promemoria_popup.winfo_height()
        screen_width = promemoria_popup.winfo_screenwidth()
        screen_height = promemoria_popup.winfo_screenheight()
        center_x = int(screen_width / 2 - window_width / 2)
        center_y = int(screen_height / 2 - window_height / 2)
