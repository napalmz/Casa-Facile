...
class GestioneSpese(tk.Tk):
    ...
    def mostra_categorie_popup(self):
        ...
        ttk.Label(aggiungi_cat_frame, text="✅ Seleziona:").grid(row=1, column=0, sticky="e", padx=4, pady=2)
        ...
        # Pulsante per chiudere la pop-up fuori dal frame principale
        style = ttk.Style()
    ...
    def add_categoria(self):
        ...
        self.nuova_cat.set("")
        self.show_custom_warning("Attenzione", f"La categoria '{nome}' e' stata aggiunta.")
    ...
    def calcola_mancanti(self):
        ...
        def analizza():
            ...
            for cat, mesi_presenti in sorted(risultati.items()):
                ...
                text_output.insert("end", f"{cat} – media: €{media_spesa:.2f}\n", "categoria")
