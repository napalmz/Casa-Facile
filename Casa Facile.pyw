  ...
  • Spesa effettiva {anno_prec}: € {stima_anno_prec:,.2f}
    ...
    def check_aggiornamento_con_api(self):
        ...
        try:
            ...
            params = {"path": NOME_FILE, "per_page": 5}
            ...
            for commit in commits:
                ...
                changelog_text += f"- [{commit_dt.strftime('%d/%m/%y %H:%M')}] {message}\n"
            ...
            if remote_time.date() > local_time.date():
                ...
                ttk.Label(win, text="\nStorico Modifiche (Changelog):", style="Timer.TLabel").pack(pady=(10, 0))
                ...
                text_area.config(state=tk.DISABLED, background="#F0F0F0") # Rende il testo non modificabile
