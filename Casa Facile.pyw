...
class GestioneSpese(tk.Tk):
    ...
    def __init__(self):
        ...
        btn_today_stats = tk.Button(
            ...
            width=2,
            height=1,
            command=self.goto_today_stats
        )
        btn_today_stats.pack(side="left", padx=(8,0))
        lbl_today_stats = tk.Label(mode_frame, font=("Arial", 8, "bold"), fg="#888")
        lbl_today_stats.pack(side="left", padx=(2, 0))
    ...
    def utenze(self):
        ...
        def apri_modale(utenza):
            ...
            #tk.Button(modal, text="💾 Salva", command=salva, width=15, bg="forestgreen", fg="white").pack(pady=10)
    ...
    def goto_today_stats(self):
        today = datetime.date.today()
        self.stats_refdate = today
        self.set_stats_mode("giorno")
        # Forza la selezione del giorno su oggi nel calendario, se vuoi anche aggiornarlo visivamente
        if hasattr(self, "cal"):
            self.cal.selection_set(today)
