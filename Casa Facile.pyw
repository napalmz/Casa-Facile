...
class GestioneSpese(tk.Tk):
    ...
    def __init__(self):
        ...
        self.bind_all("<Control-y>", lambda e: gestisci_promemoria())
        menu_funzioni.add_command(label="📋 Ricorrenze", accelerator="Ctrl+T", command=self.mostra_ricorrenza_popup)
        self.bind_all("<Control-t>", lambda e: mostra_ricorrenza_popup())
        menu_funzioni.add_separator()
        ...
        self.bind_all("<Control-Shift-K>", lambda e: self.mostra_categorie_popup())
