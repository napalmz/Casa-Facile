...
class GestioneSpese(tk.Tk):
    ...
    def __init__(self):
        ...
        barra_menu.add_cascade(label="🔁 Ricorrenze", menu=menu_ricorrenze)
        ...
        barra_menu.add_cascade(label="🛠️ Modalità", menu=menu_setup)
        ...
        style.configure("AggiungiRicorrenza.TButton", background="#32CD32", foreground="black", font=("Arial", 8))  
        style.configure("CancellaRicorrenza.TButton", background="red", foreground="black", font=("Arial", 8))  
        style.configure("ListaRicorrenze.TButton", background="#FFA500", foreground="black", font=("Arial", 8))  
        style.configure("Promemoria.TButton", foreground="black", background="orange", font=("Arial", 8))
        style.configure("Chiudi.Ricorrenze.TButton", background="yellow", foreground="black", font=("Arial", 8))  
        style.configure("SuggerisciCategoria.TButton", background="#FFA500", foreground="black", font=("Arial", 8))
        style.configure("Reset.TButton", background="yellow", foreground="black", font=("Arial", 8))
        ...
        style.configure("Salva.Promemoria.TButton", background="#32CD32", foreground="black", font=("Arial", 8))  
        style.configure("Esporta.Promemoria.TButton", background="#FFA500", foreground="black", font=("Arial", 8))  
        style.configure("Chiudi.Promemoria.TButton", background="yellow", foreground="black", font=("Arial", 8))  
        ...
        btn_scadenze_mese = ttk.Button(pannello_bottoni, text="✅", command=lambda: self.scadenze_mese(), style="Ricorrenze.TButton", width=2)
    ...
    def mostra_categorie_popup(self):
        ...
        ttk.Button(btn_frame_cat,text="↺", width=2, command=self.reset_campi_categoria,style="Reset.TButton").pack(side="left", padx=2)

        ttk.Button(main_frame, text="Chiudi", command=self.categorie_popup.withdraw, style="Reset.TButton").pack(side="bottom", pady=(0, 2))
    ...
    def mostra_ricorrenza_popup(self):
        ...
        style = ttk.Style()
        style.configure("TipoUscita.TButton", foreground="red", font=("Arial", 10, "bold"))
        style.configure("TipoEntrata.TButton", foreground="green", font=("Arial", 10, "bold"))
        ...
        self.ric_imp_entry = ttk.Entry(ric_frame, width=10, textvariable=self.ricorrenza_imp, validate="key", validatecommand=(vcmd_importo, "%P"))  
        ...
        self.btn_reset_ricorrenza = ttk.Button(btn_frame, text="↺", width=2, style="CancellaRicorrenza.TButton", command=self.reset_ricorrenza_popup)
    ...
    def on_ricorrenza_double_click(self, event):
        ...
        close_button = tk.Button(
            info_frame,
            text="✅ Chiudi",
            command=popup_movimenti.destroy,
            bg="gold",
            fg="black"
        )
    ...
    def scadenze_mese(self):
        ...
        btn_mancanti = tk.Button(
            button_frame,
            text="🔄 Calcola Mancanti",
            command=self.calcola_mancanti,
            bg="lightblue",
            fg="black",
            font=("Arial", 10, "bold"),
            relief="raised"
        )
        btn_mancanti.pack(side="left", padx=20, pady=5)

        btn_chiudi = tk.Button(
            button_frame,
            text="❌ Chiudi",
            command=popup_mensile.destroy,
            bg="gold",
            fg="black",
            font=("Arial", 10, "bold"),
            relief="raised"
        )
        btn_chiudi.pack(side="right", padx=20, pady=5)
...
# Pulsante "Calcola" con la sua larghezza normale
        ...
        btn_reset_simulazioni = ttk.Button(
            ...
            style='mutuo_prestito_yellow.TButton'
        )
        ...
        ttk.Button(common_button_frame, text="📄 Esporta Riepilogo", command=esporta_dati_con_preview, style='mutuo_prestito_green.TButton').pack(side=tk.LEFT, padx=5) 
        ttk.Button(common_button_frame, text="❌ Chiudi", command=root.destroy, style='mutuo_prestito_yellow.TButton').pack(side=tk.LEFT, padx=5) 
    ...
    def utenze(self):
        ...
        # Crea barra menu
        menu_win = tk.Menu(win, background="lightblue", foreground="black")
        # Menu "Opzioni"
        ...
        style = ttk.Style()
        style.configure("Giallo.TButton", background="yellow")
        ...
        if self.modalita == "avanzata":
         ttk.Button(top_controls, text="📂 Esporta", style="Verde.TButton", command=esporta_preview).pack(side=tk.LEFT, padx=2)
         ttk.Button(top_controls, text="⚙️ Analizza", style="Verde.TButton",command=lambda: crea_tabella_consumi(UTENZE_DB)).pack(side=tk.LEFT, padx=2)
         ttk.Button(top_controls, text="📂 Esporta DB", style="Rosso.TButton", command=lambda: esporta_letture_data(UTENZE_DB)).pack(side=tk.LEFT, padx=2)
         ttk.Button(top_controls, text="📂 Importa DB", style="Rosso.TButton", command=lambda: importa_letture_data(letture_salvate, anagrafiche)).pack(side=tk.LEFT, padx=2)
        ...
        for utenza in utenze:
                ...
                tk.Button(
                    ...
                    text="💾 Salva",
                    width=10,
                    command=lambda u=utenza: salva_dati(u),
                    bg="forestgreen",
                    fg="white",
                    font=("Arial", 10)
                ).pack(pady=(0, 5))
                ...
                tk.Button(
                    ...
                    text="📄 Modifica",
                    width=10,
                    command=lambda u=utenza: modifica_dati(u),
                    bg="gold",
                    fg="black",
                    font=("Arial", 10)
                ).pack()
    ...
    def cerca_operazioni(self):
        ...
        for txt, cmd, bg in [
            ("🔍 Cerca", esegui_ricerca, "forestgreen"),
            ("📄 Esporta", esporta_risultato, "orange"),
            ("⚙️ Filtri avanzati", apri_filtri_avanzati, "dodgerblue"),
            ("↺ Reset", resetta_campo, "gold"),
            ("❌ Chiudi", finestra.destroy, "red")
        ]:
            tk.Button(
                frame_bottoni,
                text=txt,
