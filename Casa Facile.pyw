...
GITHUB_FILE_URL = "https://raw.githubusercontent.com/Renato-4132/Gestione-spese/refs/heads/main/Casa%20Facile.pyw"
...
class GestioneSpese(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.title("Casa Facile pro v.4.0")
        ...
        ttk.Button(topbar, text="📤 Importa Database", command=self.import_db, style="Importa.TButton").pack(side=tk.RIGHT, padx=6)
        ttk.Button(topbar, text="📤 Esporta Database", command=self.export_db, style="Esporta.TButton").pack(side=tk.RIGHT, padx=6)
        ...
        ttk.Button(topbar, text="💰 Saldo Conto", command=self.open_saldo_conto, style="Saldo.TButton").pack(side=tk.LEFT, padx=6)
    ...
    def show_info_app(self):
            ...
            info = (
                ...
                "• Per esportare i dati di un mese o di un anno specifico, seleziona mese e anno dal riquadro sinistro e poi usa i pulsanti 'Esporta mese da estratto' o 'Esporta anno da estratto'.\n\n"
                 ...
                 "  sudo apt install tkcalendar, sudo apt install python3-psutil, sudo apt install python3-urllib3\n"
                 "Su Windows:\n"
                 "  Apri il terminale (Prompt dei comandi) e digita:\n"
                 "  py -m pip install tkcalendar, py -m pip install psutil, py -m pip install urllib3()\n"
        ...
        def stampa():
            ...
            try:
                if sistema == "Windows":
                    ...
                    subprocess.run(["notepad", "/p", path], check=True)
                    ...
                    subprocess.run([
                        ...
                        "-o", "fit-to-page",
                        "-o", "cpi=17",
                        "-o", "lpi=8",                     # linee per pollice (opzionale)
                        path
                    ], check=True)
