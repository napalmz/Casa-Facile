...
class GestioneSpese(tk.Tk):
    ...
    def __init__(self):
        ...
        style.configure("Oggi.blue.TButton", background="#0099ff", foreground="black", font=("Arial", 8))  # Manuale - verde chiaro
        ...
        ttk.Label(legenda, text="Entrata", background="lightgreen", width=10, anchor="center", font=("Arial", 10)).pack(side="left", padx=3)
        ttk.Label(legenda, text="Uscita", background="lightcoral", width=10, anchor="center", font=("Arial", 10)).pack(side="left", padx=3)
        ttk.Label(legenda, text="Entrata + Uscita", background="khaki", width=16, anchor="center", font=("Arial", 10)).pack(side="left", padx=3)
        ttk.Label(legenda, text="Oggi", background="blue", foreground="white", width=8, anchor="center", font=("Arial", 10)).pack(side="left", padx=3)
...
# 🔴 Riepilogo Mese
        ...
        style.configure("Reset.aggiungi.TButton", foreground="white", background="#808080", font=("Arial", 8))
