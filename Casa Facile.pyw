...
class GestioneSpese(tk.Tk):
    ...
    def show_info_app(self):
        ...
        text.insert("end", "  sudo apt install tkcalendar python3-psutil python3-urllib3\n")
        text.insert("end", "  Oppure:\n")
        text.insert("end", "  pip install tkcalendar psutil urllib3\n")

        text.insert("end", "\nSu Windows:\n")
        text.insert("end", "  Apri il Prompt dei comandi e digita:\n")
        text.insert("end", "  py -m pip install tkcalendar psutil urllib3 win32print win32api win32con\n")
...
def install_urllib3():
    """Controlla se urllib3 è installato e, se mancante, lo installa automaticamente, quindi restituisce urllib.request"""
